    ...
    function submitMessage() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                var aiResponseHTML = marked(aiResponse); // Convert Markdown to HTML
                ...
                $('.chat-history').append(
                    ...
                    '<div><strong>AI:</strong> ' + aiResponseHTML + '</div></div>'
                );
...
//         // Place all code that depends on the Marked library here
//         // This ensures Marked is loaded before this code runs.
...
//         // All other functions, like submitMessage and uploadCharacterCard, go inside initializeChatFunctions
//         // This way, they are defined only after the Marked library is confirmed to be loaded.
//         //     // Function to handle the message submission
//     function submitMessage() {
//         var userInput = $('#user_input').val(); // Get the user input
//         if(userInput.trim() === '') {
...
//                 var aiResponse = response.ai_response;
//                 // var aiResponseHTML = marked(aiResponse); // Convert Markdown to HTML
//                 var aiResponseHTML = window.marked ? window.marked(aiResponse) : aiResponse;
